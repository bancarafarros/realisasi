                ...
                <div class="row">
                    ...
                    <?php echo $this->session->flashdata('message'); ?>
                        ...
                        <div class="card card-primary">
                            ...
                            <div class="card-body">
                                <form method="POST" action="<?php echo base_url('CAuth/login') ?>" class="needs-validation" novalidate="">
                                    <div class="form-group">
                                        <label for="username">Username</label>
                                        <input type="text" class="form-control" name="username_pengguna" tabindex="1" required autofocus>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="password" class="form-control" name="password_pengguna" tabindex="2" required>
                                        <div class="invalid-feedback">
